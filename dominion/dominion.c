...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      srand(time(NULL));
      drawntreasure = rand() % 10;
      z = rand() % 5;
      printf("Drawntreasure: %d\n", drawntreasure);
      printf("Z: %d\n", z);
      while(drawntreasure<2){
        printf("Drawntreasure was greater then 2: %d\n", drawntreasure);
    ...
    printf("Card drawn was not copper, silver, or gold. Z was: %d\n", z);
    ...
    case village:
      ...
      state -> numActions = randomnumber;
      printf("Numactions = to random roll: %d \n", state -> numActions);
      state->numActions = state->numActions + 2;
      printf("Numactions = to random roll after + 2: %d\n", state -> numActions);
    ...
    case great_hall:
      ...
      state -> numActions = randomness;
      printf("Number of Actions Before (random number): %d\n", randomness);
      state->numActions++;
